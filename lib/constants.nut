...
constants.INF <- 10e100
constants.NAN <- 0.0 / 0

constants.RAD_TO_DEG <- 57.2957795

constants.STATE_DISABLED <- 0
constants.STATE_ENABLED <- 1

///////////////////////////////////////////////////////

if (!("dont_add_constants_to_roottable" in this) || !dont_add_constants_to_roottable) {
	log("[lib] adding constants to root table")
	foreach (constant, value in constants) this[constant] <- value
}